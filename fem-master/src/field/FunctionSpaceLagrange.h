...
#ifndef H_GMSHFEM_FUNCTIONSPACELAGRANGE
#define H_GMSHFEM_FUNCTIONSPACELAGRANGE
...
namespace gmshfem::field
{
  ...
  class FunctionSpaceLagrange final : public FunctionSpace< T_PScalar, Form::Form0 >
  {
   private:
    unsigned int _order;
    
   public:
    FunctionSpaceLagrange(const unsigned int order = 0);
    ~FunctionSpaceLagrange();
    ...
    virtual FunctionSpaceLagrange *copy() const override;
...
#endif // H_GMSHFEM_FUNCTIONSPACELAGRANGE
