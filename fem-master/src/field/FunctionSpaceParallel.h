...
#ifndef H_GMSHFEM_FUNCTIONSPACEPARALLEL
#define H_GMSHFEM_FUNCTIONSPACEPARALLEL
...
namespace gmshfem::field
{
  ...
  class FunctionSpaceParallel final : public FunctionSpace< T_PScalar, Form::Form2 >
  {
   private:
    FunctionSpace< T_PScalar, Form::Form1 > *const _fs;

   public:
    FunctionSpaceParallel(const FunctionSpace< T_PScalar, Form::Form1 > &fs);
    ~FunctionSpaceParallel();
    ...
    virtual FunctionSpaceParallel *copy() const override;
...
#endif // H_GMSHFEM_FUNCTIONSPACEPARALLEL
