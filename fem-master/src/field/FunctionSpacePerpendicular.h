...
#ifndef H_GMSHFEM_FUNCTIONSPACEPERPENDICULAR
#define H_GMSHFEM_FUNCTIONSPACEPERPENDICULAR
...
namespace gmshfem::field
{
  ...
  class FunctionSpacePerpendicular final : public FunctionSpace< T_PScalar, Form::Form1 >
  {
   private:
    FunctionSpace< T_PScalar, Form::Form0 > *const _fs;

   public:
    FunctionSpacePerpendicular(const FunctionSpace< T_PScalar, Form::Form0 > &fs);
    ~FunctionSpacePerpendicular();
    ...
    virtual FunctionSpacePerpendicular *copy() const override;
...
#endif // H_GMSHFEM_FUNCTIONSPACEPERPENDICULAR
