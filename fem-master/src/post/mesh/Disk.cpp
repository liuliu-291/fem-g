...
namespace gmshfem::post
{
  ...
  Disk::Disk(const std::string &name, const double xCenter, const double yCenter, const double zCenter, const double radius, const double xNormal, const double yNormal, const double zNormal, const unsigned int numPoints) :
  ...
  void Disk::generateMesh() const
  {
    ...
    int ll = gmsh::model::geo::addCurveLoop(lines);
