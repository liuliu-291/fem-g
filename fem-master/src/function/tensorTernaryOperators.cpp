...
namespace gmshfem::function
{
  ...
  Function< T_Scalar, Degree::Degree2 > tensorDiag(const GeneralEvaluableObject< T_Scalar, Degree::Degree0 > &a, const GeneralEvaluableObject< T_Scalar, Degree::Degree0 > &b, const GeneralEvaluableObject< T_Scalar, Degree::Degree0 > &c)
  {
    if(a.getEvaluableFunction().isTrivial() && b.getEvaluableFunction().isTrivial() && c.getEvaluableFunction().isTrivial()) {
      ...
      mat << a.value(), 0., 0., 0., b.value(), 0., 0., 0., c.value();
